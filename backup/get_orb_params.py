...
base_name = raw_input("Enter filename: ")
...
data = fi.read_file(str(base_name),",")
...
print("Apogalacticon = " + str(apo_avg) + " +/- " + str(apo_dev))
print("Perigalacticon = " + str(peri_avg) + " +/- " + str(peri_dev))
print("Eccentricity = " + str(ecc_avg) + " +/- " + str(ecc_dev))
print("Inclination = " + str(inc_avg) + " +/- " + str(inc_dev))