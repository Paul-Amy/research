...
def vdisp(nbodyl,nbodyb,nbodyv,nbodyr,orbl,orbb,orbv,orbr):
  ...
  print str("b disp (avg) = " + str(bsig))
  print str("v disp = " + str(vstdev))
  print str("v disp (avg) = " + str(vsig))
  print str("r disp = " + str(rstdev))
  print str("r disp (avg) = " + str(rsig))
...
if __name__ == "__main__": 	
	...
	while index < iterations + 1:
	  nbody = fi.read_file("orphan.2.5e6.200pc.orb3.polyfit.0to2deg", ",")
	  orbit = fi.read_file("orphantest3.combined.500M.csv.params.small", ",")
