...
def Disk_velocity(l1,b1,x1,y1,z1,rgal1,rsol1,vgsr1,l2,b2,x2,y2,z2,rgal2,rsol2,vgsr2,l3,b3,x3,y3,z3,rgal3,rsol3,vgsr3):
	...
	os.system("touch hyllus.1e8.800pc.orb7.polyfit.2deg")
	test1=open('hyllus.1e8.800pc.orb7.polyfit.2deg','r+') #name of output file
	j=0
...
if __name__ == "__main__": 	
	...
	data1=fi.read_file("hyllus.1e8.800pc.orb7.nbody.csv.params", ",") #name of input nbody file
	
	data2=fi.read_file("hyllustest7.forward.150M.csv.params.small", ",") #names of input orbit files
	data3=fi.read_file("hyllustest7.forward.150M.csv.params.small", ",")
